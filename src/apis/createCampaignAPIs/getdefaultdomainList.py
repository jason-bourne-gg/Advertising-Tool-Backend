...
getdefaultdomainlist_blueprint = Blueprint('getdefaultdomainlist', __name__)

getdefaultdomainlist_store = {}

@getdefaultdomainlist_blueprint.route('/getdefaultdomainlist', methods=['GET'])
@login_required
def getDefaultDomainList():
    ...
    try:
        ...
        return jsonify({'download_url': download_url, 'fileName':file_name , 'statusMessage':"Success"})
