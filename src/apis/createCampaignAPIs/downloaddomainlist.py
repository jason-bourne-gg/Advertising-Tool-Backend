...
downloaddomainlist_blueprint = Blueprint('downloaddomainlist', __name__)

downloaddomainlist_store = {}

@downloaddomainlist_blueprint.route('/downloaddomainlist', methods=['POST', 'GET'])
@login_required
def downloadDomainList():
    
    directory_name = request.json.get("campaign_name")
    ...
    try:
        ...
        blob_name = f'DomainLists/{directory_name}/{file_name}'
